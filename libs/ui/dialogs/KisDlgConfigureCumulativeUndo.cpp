    ...
    , m_d(new Private(data))
{
    ...
    intExcludeFromMerge->setToolTip(
        i18nc("@info:tooltip",
              "The number of last strokes that Krimble will not merge "
    ...
    QLabel *help = new QLabel(
        i18n("Cumulative Undo allows Krimble to merge undo actions "
             "and make undo history cleaner. Krimble will still keep "
             ...
             "\"Exclude last strokes from merge\", Krimble will try "

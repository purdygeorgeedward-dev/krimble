...
void DlgCreateBundle::accept()
{
    ...
    if (name.isEmpty()) {
        ...
        QMessageBox::warning(this, i18nc("@title:window", "Krimble"), i18n("The resource bundle name cannot be empty."));
        return;
    }
    ...
    if (m_pageBundleSaver->saveLocation().isEmpty() ){
        ...
        QMessageBox::warning(this, i18nc("@title:window", "Krimble"), i18n("The save location cannot be empty."));
        return;
    }
    else {

...
void KisMultiChannelConfigWidget::setConfiguration(const KisPropertiesConfigurationSP config)
{
    ...
    if (cfg->curves().empty()) {
        ...
        QMessageBox::warning(this, i18nc("@title:window", "Krimble"), i18n("The current configuration was created for a different colorspace and cannot be used. All curves will be reset."));
